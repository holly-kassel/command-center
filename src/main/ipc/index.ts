...
export { registerRitualIpc } from './ritual'
export { registerGoalIpc } from './goal'
export { registerKanbanIpc } from './kanban'
export { registerTranscriptionIpc } from './transcription'
export { registerChatIpc } from './chat'
export { registerDecisionEvalIpc } from './decisionEval'
